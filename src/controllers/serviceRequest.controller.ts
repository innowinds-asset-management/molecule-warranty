...
export class ServiceRequestController {
  ...
  async getServiceRequestPaginated(req: Request, res: Response) {
    try {
      ...
      const result = await this.serviceRequestService.getServiceRequestPaginated(
        Number(page),
        Number(limit),
        assetId as string
      );
  ...
  async getServiceRequestById(req: Request, res: Response) {
    try {
      const { id } = req.params;
      const result = await this.serviceRequestService.getServiceRequestById(Number(id));
      res.status(200).json(result);
    } catch (error) {
      res.status(500).json({ error: 'Failed to fetch service request' });
    }
  ...
  async createServiceRequest(req: Request, res: Response) {
    try {
      ...
      const result = await this.serviceRequestService.createServiceRequest(data);
  ...
  async updateServiceRequest(req: Request, res: Response) {
    try {
      const { id } = req.params;
      const data = req.body as ServiceRequestDto;
      const result = await this.serviceRequestService.updateServiceRequest(Number(id), data);
      res.status(200).json(result);
    } catch (error) {
  ...
  async getServiceRequestByAssetId(req: Request, res: Response) {
    try {
      ...
      const result = await this.serviceRequestService.getServiceRequestByAssetId(assetId as string);
      res.status(200).json(result);
    } catch (error) {
      res.status(500).json({ error: 'Failed to fetch service request' });
    }
  ...
  async deleteServiceRequest(req: Request, res: Response) {
    try {
      const { id } = req.params;
      await this.serviceRequestService.deleteServiceRequest(Number(id));
      res.status(204).send();
    } catch (error) {
